...
func (n *NginxPlusStatus) SampleConfig() string {
	return sampleConfig
}

func (n *NginxPlusStatus) Description() string {
	return "Read Nginx Plus' full status information (ngx_http_status_module)"
}

func (n *NginxPlusStatus) Gather(acc telegraf.Accumulator) error {
...
func (n *NginxPlusStatus) createHttpClient() (*http.Client, error) {
...
func (n *NginxPlusStatus) gatherUrl(addr *url.URL, acc telegraf.Accumulator) error {
